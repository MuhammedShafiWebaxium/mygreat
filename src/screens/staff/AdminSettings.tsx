...
import { Bell, History, Save, Settings2, RefreshCw, CircleDollarSign, ExternalLink } from 'lucide-react'
import { getFinance, savePriorityPrice } from '@/features/support/support.functions'
import { getExchangeRateSettingsFn, refreshExchangeRatesFn, type ExchangeRateSettings } from '@/features/admin/admin.functions'
import { cn } from '@/lib/utils'

type SettingsTab = 'subscription' | 'exchange-rates' | 'general' | 'notifications'
...
export default function AdminSettings() {
  ...
  useEffect(() => { load();getExchangeRateSettingsFn().then(setRates).catch(()=>{}) }, [])
