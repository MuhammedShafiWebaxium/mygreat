...
import { BookOpen, CheckCircle2, FilePlus2, GraduationCap, X } from 'lucide-react'
...
export function DesiredUniversities({ studentId, universities, appliedUniversityIds, selectedCourse }: {
  studentId: string
  ...
  const create = useMutation({
    mutationFn: () => staffCreateApplicationFn({ data: { studentId, universityId: selected?.id, program: selectedCourse } }),
